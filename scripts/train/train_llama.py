...
# ────────────────────────────
os.environ["CUDA_VISIBLE_DEVICES"] = "6"        # GPU a utilizar
...
CHECKPOINT_DIR  = "./QLoRA_LLaMA2_7B_Checkpoints_vDESC_CHILL"
...
# }
descriptions = {
        "Normal": "no signs of mental disorder",
        "Depression": "symptoms of depression",
        "Bi-polar": "bipolar symptoms",
...
def create_prompt(row, max_examples=5, deterministic=True):
    ...
    prompt = (
        ...
        f"### Tweet examples\n{examples_txt}\n\n"
        f"### Instruction\n"
        f"Write one new tweet that captures the mental state of someone with **{status}**.  "
